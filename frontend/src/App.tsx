...
import { ReactComponent as StartupLogo } from 'images/startup_logo.svg'
...
const App = () => {
  ...
  const suggestedQueries = [
    'What healthcare startups are in the news?',
    "Any overlap between fintech and AI",
    'Does Sequoia capital fund any startups recently?',
    'What startups recently got Series B funding?',
    'What international startups are in the news?',
  ]
          ...
          <>
            {hasSummary ? (
              ...
              <div className="h-36 p-6 bg-white rounded-md shadow flex flex-col justify-start items-center gap-4 mt-6">
                <StartupLogo className="w-16 h-16" />
